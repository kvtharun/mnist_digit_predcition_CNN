...
function draw(ctx,x,y,_size,isDown)
{
    if(isDown)
...
(async function(){  
    ...
    model = await tf.loadLayersModel("https://github.com/kvtharun/mnist_digit_predcition_CNN/blob/376c3899f9b81a930ce1202b14fccf7db0c8ccde/models.json")
